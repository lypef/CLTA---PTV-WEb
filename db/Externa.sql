...
--
-- Servidor: localhost
-- Tiempo de generación: 26-09-2018 a las 22:47:24
...
INSERT INTO `empresa` (`id`, `nombre`, `nombre_corto`, `direccion`, `correo`, `telefono`, `mision`, `vision`, `contacto`, `facebook`, `twitter`, `youtube`, `iva`, `footer`) VALUES
(1, 'Distribuidora de Tracto Partes Loaiza', 'DTP-L', 'LATERAL DE INSURGENTES 13 FRACC. LAS MARGARITAS CHILPANCINGO  GRO        ', 'contacto@distribuidoradetractopartesloaiza,com', ' 7474914526  cel. 7471619824', 'SERVIMOS A EL SECTOR DE LA MAQUINARIA , LA MINERÍA Y LA CONSTRUCCIÓN CON PRODUCTOS DE INMEJORABLE CALIDAD, LA MEJOR LOGÍSTICA, UN GRAN SURTIDO DE PARTES Y EL MEJOR SERVICIO.', 'TENEMOS LA VISIÓN DE UN MEJOR PAÍS APORTANDO NUESTRO GRANO DE ARENA PARA CONSTRUIR INFRAESTRUCTURA Y APOYANDO AL PROGRESO CON NUESTROS SERVICIOS', 'contacto@distribuidoradetractopartesloaiza.com', 'https://www.facebook.com/DTPL-Chilpancingo', '', '', 16, 'Poner codigo html aqui con numeros de cuenta');

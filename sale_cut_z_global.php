<?php
    ...
    $con = db_conectar();  
    $sales = mysqli_query($con,"SELECT u.nombre, c.nombre, v.descuento, v.fecha, v.cobrado, v.fecha_venta, v.folio FROM folio_venta v, users u, clients c WHERE v.vendedor = u.id and v.client = c.id and v.open = 0 and v.cut_global = 0 ");
